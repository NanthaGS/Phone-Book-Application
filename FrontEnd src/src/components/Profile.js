    ...
    <div className="back" style={{ backgroundColor: 'lightgrey' }}>
      ...
      <div className="profile-container">
        <div className="profile-header">
          ...
          <h1 className="mainH">Nantha G S</h1>
        </div>
        <div className="profile-details">
          <div className="profile-info">
            <h2 className="profile-info-title">Personal Information</h2>
            <p className="profile-info-item">
              <span className="profile-info-label">Email:</span> nanthadgl2003@gmail.com
            </p>
            <p className="profile-info-item">
              <span className="profile-info-label">Phone:</span> 9344735276
            </p>
            <p className="profile-info-item">
              <span className="profile-info-label">Location:</span> Coimbatore, India
            </p>
          </div>
